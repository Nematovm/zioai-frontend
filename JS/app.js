...
window.addEventListener('load', () => {
  // Butun spinner-wrapper ni fade out qilamiz
  spinnerWrapperEL.style.opacity = '1';

  // 2 sekund kutib, display none qilamiz
  setTimeout(() => {
...
ScrollReveal().reveal('.main-subtitle', {
    distance: '50px',
    duration: 800,  
    easing: 'ease-in-out',
    origin: 'left',
...
ScrollReveal().reveal('.reveal-card-2', {
    distance: '50px',
    duration: 800,
    easing: 'ease-in-out',
    origin: 'bottom',
...
ScrollReveal().reveal('.reveal-card-3', {
    distance: '50px',
    duration: 800,
    easing: 'ease-in-out',
    origin: 'top',
...
ScrollReveal().reveal('.reveal-card-4', {
    distance: '50px',
    duration: 800,
    easing: 'ease-in-out',
    origin: 'right',
...
ScrollReveal().reveal('.team-anim-card', {
    distance: '50px',
    duration: 800,
    easing: 'ease-in-out',
    origin: 'left',
...
ScrollReveal().reveal('.team-anim-card-2', {
    distance: '50px',
    duration: 800,
    easing: 'ease-in-out',
    origin: 'right',
...
ScrollReveal().reveal('.premium-title', {
    distance: '100px',
    duration: 1000,
    easing: 'ease-in-out',
    origin: 'top',
...
ScrollReveal().reveal('.premium-subtitle', {
    distance: '50px',
    origin: 'bottom',
    duration: 1000,
    opacity: 0,
...
// End of Scroll Reveal Animations
